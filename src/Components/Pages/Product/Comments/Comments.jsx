  ...
  return (
    <section className="bg-white p-5  rounded-2xl shadow-lg shadow-black/5">
        <header>
            ...
            <div className="mt-4">
                <textarea name="" id="" className='w-full bg-gray-100/50 rounded-xl outline-none p-5' placeholder='نظر خود را درج کنید ...' resize={"off"} rows="2"></textarea>
                <div className="flex-end">
                    <button className='px-4 mt-2 shadow-lg shadow-secondary/30 hover:bg-opacity-90 duration-150 py-1.5 rounded-lg bg-secondary text-white text-sm'>درج نظر</button>
                </div>
            </div>
        </header>
        <main className='mt-5 divide-y'>
            {
                product && product.product && product.product.last_comments ? 
